...
//		//add
//    if (isset($this->error['txt'])) {
//      $data['error_txt'] = $this->error['txt'];
//    } else {
//      $data['error_txt'] = '';
//    }
//    //
...
//      $data['txt'] = $this->request->post['txt'];
//    } elseif (!empty($module_info)) {
//      $data['txt'] = $module_info['txt'];
//    } else {
//      $data['txt'] = '';
//    }
//    //
...
//		//add
//    if (!$this->request->post['txt']) {
//      $this->error['txt'] = $this->language->get('error_txt');
//    }
//    //
