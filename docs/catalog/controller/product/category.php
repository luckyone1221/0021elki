	...
	public function index() {
		...
		if ($category_info) {
			...
			if ($category_info['meta_title']) {
				...
				$this->document->setTitle($category_info['name'] . ' - купить с доставкой по Москве' );
			}
			...
			$this->document->setDescription($category_info['name'].' - купить с доставкой по Москве на сайте ELKI.SALE. Быстрая доставка! Гарантия качества! Успей купить до Нового года!');
