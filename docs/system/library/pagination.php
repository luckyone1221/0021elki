...
class Pagination {
  ...
  //	public $text_prev = '&lt;';
	...
	public function render() {
      ...
      $output .= '<li><a href="#" class="pointer-event-none">' . $this->text_prev . '</a></li>';
    }
		...
		//defult == uncomend if, and remove else
		if ($page < $num_pages) {
      ...
      $output .= '<li><a href="' .$this->url. '" class="pointer-event-none">' . $this->text_next . '</a></li>';
    }
    //
